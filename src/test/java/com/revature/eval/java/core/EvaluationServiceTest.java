...
public class EvaluationServiceTest {
	...
	public void testAnEmptyString() {
		assertEquals("", evaluationService.reverseString(""));
	}

	@Test
	public void testAWord() {
		assertEquals("tobor", evaluationService.reverseString("robot"));
	}

	@Test
	public void testACapitalizedWord() {
		assertEquals("nemaR", evaluationService.reverseString("Ramen"));
	}

	@Test
	public void testASentenceWithPunctuation() {
		assertEquals("!yrgnuh m'I", evaluationService.reverseString("I'm hungry!"));
	}

	@Test
	public void testAPalindrome() {
		assertEquals("racecar", evaluationService.reverseString("racecar"));
	}
